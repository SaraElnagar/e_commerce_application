          ...
          child: Column(
            ...
            children: [
              ...
              BuildTextField(
                ...
                label: 'Full Name',
                controller: TextEditingController(text: 'Nour Nour Nabil'),
              ...
              BuildTextField(
                ...
                controller: TextEditingController(text: 'nour.N@gmail.com'),
                labelTextStyle: getMediumStyle(
                    color: ColorManager.primary, fontSize: FontSize.s18),
                suffixIcon: IconButton(
                  icon: SvgPicture.asset(SvgAssets.edit),
              ...
              BuildTextField(
                controller:
                    TextEditingController(text: 'Sheikh Zayed, street 17.....'),
                borderBackgroundColor: ColorManager.primary.withOpacity(.5),
                readOnly: isAddressReadOnly,
                backgroundColor: ColorManager.white,
                hint: 'Sheikh Zayed, street 17.....',
                label: 'Your Address',
                labelTextStyle: getMediumStyle(
                    color: ColorManager.primary, fontSize: FontSize.s18),
                suffixIcon: IconButton(
